...
### Preventive Measures:
To prevent further outages of this nature in future, I suggested that we set up a monitoring agent like DataDog on the backup server to inform us about server health, possible errors, memory or network overloads, etc which could 
